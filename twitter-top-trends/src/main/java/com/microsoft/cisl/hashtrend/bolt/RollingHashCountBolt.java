...
import com.microsoft.cisl.hashtrend.window.NthLastModifiedTimeTracker;
import com.microsoft.cisl.hashtrend.window.SlidingWindowCounter;
 ...
 */
public class RollingHashCountBolt extends BaseRichBolt {

    private static final long serialVersionUID = 5537727428628598519L;
    private static final Logger LOG = Logger.getLogger(RollingHashCountBolt.class);
    ...
    public RollingHashCountBolt() {
        this(DEFAULT_SLIDING_WINDOW_IN_SECONDS, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
    }

    public RollingHashCountBolt(int windowLengthInSeconds, int emitFrequencyInSeconds) {
    ...
    private void emitCurrentWindowCounts() {
        ...
        LOG.debug("Counts to Emit: "+ counts);
    ...
    private void countObjAndAck(Tuple tuple) {
        ...
        LOG.debug(" RollingHashCount => "+ (String) obj);
